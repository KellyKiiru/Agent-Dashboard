...
@Component({
  selector: 'app-invoice-addition',
  templateUrl: './invoice-addition.component.html',
  styleUrl: './invoice-addition.component.css'
})
export class InvoiceAdditionComponent implements OnInit{
  invoices: Invoice[] = [];
  ...
  calculateBalance() {
    this.currentInvoice.balance = this.currentInvoice.amount - (this.currentInvoice.paidAmount || 0);
  }
